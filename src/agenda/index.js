...
export default class AgendaView extends Component {
  ...
  constructor(props) {
    ...
    this.knobHeight = props.knobHeight || KNOB_HEIGHT;
  ...
  render() {
    ...
    return (
      <View testID={this.props.testID} onLayout={this.onLayout} style={[this.props.style, {flex: 1, overflow: 'hidden'}]}>
        ...
        <Animated.View style={headerStyle}>
          <Animated.View style={{flex:1, transform: [{translateY: contentTranslate}]}}>
            <CalendarList
              ...
              weekHeight={this.props.weekHeight}
            />
          </Animated.View>
          {knob}
        </Animated.View>
        ...
        >
          <View testID={AGENDA_CALENDAR_KNOB} style={{height: agendaHeight + this.knobHeight}} onLayout={this.onScrollPadLayout}/>
        </Animated.ScrollView>
      </View>
    );
  }
